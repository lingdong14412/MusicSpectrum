...
void extractFrequencyBands() {
  ...
  // 频段7: 3200-5000Hz
  barTargets[6] = vReal[23] * 0.1f + vReal[24] * 0.1f + vReal[25] * 0.09f + vReal[26] * 0.1f;
  
  // 频段8: 5000-8000Hz (提高权重，通常音乐高频能量较低)
  barTargets[7] = vReal[27] * 0.08f + vReal[28] * 0.1f + vReal[29] * 0.08f + vReal[30] * 0.1f;
  barTargets[7] *= 0.5f;  // 提高高频增益
